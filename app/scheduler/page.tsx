      ...
      <main className="mx-auto max-w-6xl px-4 py-8">
        ...
        {rows.length === 0 ? (
          <div className="rounded-xl border border-zinc-200 bg-white px-6 py-12 text-center dark:border-zinc-800 dark:bg-zinc-900">
            <p className="text-zinc-500 dark:text-zinc-400">No schedulers yet. Create your first scheduler.</p>
          </div>
        ) : (
                ...
                >
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <span className="text-xs text-zinc-500 dark:text-zinc-400">
                      {s.mode} · target {s.targetTrackCount} · {s.sourceCount} sources · {s.slotCount} slots · {s.runCount} runs
                    </span>
                  </div>
                </Link>
              </li>
